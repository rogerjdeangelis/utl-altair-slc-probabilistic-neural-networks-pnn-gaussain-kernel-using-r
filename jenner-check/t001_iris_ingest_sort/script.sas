/* Iris ingest + sort from utl-altair-slc-probabilistic-neural-networks-pnn-gaussain-kernel-using-r.sas */
/* The workx SLC library is remapped to WORK so the step runs standalone.                              */
...
/* class distribution across the full 150-row sample, before the by-species sort */
